...
MAX_GUESSES = 10 # adjust for difficulty

def main():
    print('''Bagels, a deductive logic game. I  am thinking of a {}-digit number with no repeated digits. Try to guess what it is. Here are some clues:
    ...
    for i in range(len(guess)):
        ...
        if len(clues) == 0:
         ...
         # Sort the clues into alphabetical order so their original order doesn't give information away”
            clues.sort()
         # Make a single string from the list ofstring clues. 
            return ' '.join(clues)
